...
export default function Hero() {
  return (
    <div className=' text-white mb-10 relative'>
      <div className='w-full h-96 mt-6 rounded-lg overflow-hidden mask-t-from-1.5'>
        <div className='absolute inset-0 bg-gradient-to-t from-black to-transparent opacity-100 z-100' />
        <motion.div
          initial={{ opacity: 0, y: 40 }}
          animate={{ opacity: 1, y: 0 }}
          transition={{ duration: 0.8 }}
          className='relative z-200 max-w-3xl p-8 flex flex-col justify-end gap-3 h-full'
        >
