    ...
    <div className="mt-auto">
      <footer className="text-center p-4 flex sm:flex-row items-center sm:justify-between border-t-[0.5px] border-gray-300 flex-col justify-center mt-5 gap-4 sm:gap-0">
        <div className="flex flex-col items-center sm:items-start">
          ...
          <p className="text-sm text-gray-500 mt-2">&copy; 2025 The Free Agent Portal</p>
          <p className="text-xs text-gray-500 mt-1">
            "The Free Agent Portal" is a joint venture service of Sterling Haven LLC and Draft Diamonds LLC.
          </p>
        </div>
        <div className="flex flex-col sm:flex-row sm:items-start items-center text-sm text-gray-500 gap-6 sm:gap-8">
          <div className="text-center sm:text-right">
            ...
            <div className="text-xs space-y-1">
              <p>
                Billing:{" "}
                <a href="mailto:info@sterlinghavenllc.com" className="hover:underline text-blue-600">
                  info@sterlinghavenllc.com
                </a>
              </p>
              <p>
                Support:{" "}
                <a href="mailto:support@thefreeagentportal.com" className="hover:underline text-blue-600">
          ...
          <div className="text-center sm:text-right">
            ...
            <a href="/legal/terms" className="hover:underline mb-1 block text-xs">
              Terms of Use
            </a>
            <a href="/legal/privacy" className="hover:underline mb-1 block text-xs">
              Privacy Policy
            </a>
      ...
      {/* Credit Card Brands */}
      <div className="border-t-[0.5px] border-gray-200 py-3 px-4">
